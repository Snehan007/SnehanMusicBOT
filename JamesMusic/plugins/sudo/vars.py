...
`UPSTREAM_REPO` : **Contact: @shutupjames**
`UPSTREAM_BRANCH` : **Contact: @shutupjames**
`GITHUB_REPO` : **Contact: @shutupjames**
`GIT_TOKEN `: **Contact: @shutupjames**
...
**<u>URL Vars:</u>**
`SUPPORT_CHANNEL` : **Not Available**
`SUPPORT_GROUP` : **Not Available**
`START_IMG_URL` : **{start}**
    """
